...
export class RouteListItem {
    ...
    constructor(url: string, data: Record<string, string>, func: Function) {
        this.url = url;
        this.data = data;
        this.func = func;
    }
...
export const listOfRoutes: RouteListItem[] = [
    ...
    new RouteListItem('/ryzthn/rpc/Login', {
    ...
    // new RouteListItem('/ryzthn/rpc/GetGameSessionTicket', {}, handlers.GetGameSessionTicketHandler),
    // new RouteListItem('/ryzthn/rpc/RedeemGameSessionTicket', {}, handlers.RedeemGameSessionTicketHandler),
    // new RouteListItem('/ryzthn/rpc/Logout', {}, handlers.LogoutHandler),
    // new RouteListItem('/ryzthn/rpc/GetStoredPaymentMethods', {}, handlers.GetStoredPaymentMethodsHandler),
    // new RouteListItem('/ryzthn/rpc/CreateStoredPaymentMethod', {}, handlers.CreateStoredPaymentMethodHandler),
    // new RouteListItem('/ryzthn/rpc/UpdateStoredPaymentMethod', {}, handlers.UpdateStoredPaymentMethodHandler),
    // new RouteListItem('/ryzthn/rpc/SetDefaultStoredPaymentMethod', {}, handlers.SetDefaultStoredPaymentMethodHandler),
    // new RouteListItem('/ryzthn/rpc/RemoveStoredPaymentMethod', {}, handlers.RemoveStoredPaymentMethodHandler),
    // new RouteListItem('/ryzthn/rpc/SubmitPurchaseOrder', {}, handlers.SubmitPurchaseOrderHandler),
    // new RouteListItem('/ryzthn/rpc/GetPurchaseOrder', {}, handlers.GetPurchaseOrderHandler),
    // new RouteListItem('/ryzthn/rpc/GetAccountOrderHistory', {}, handlers.GetAccountOrderHistoryHandler),
    // new RouteListItem('/ryzthn/rpc/GetAccountBalanceHistory', {}, handlers.GetAccountBalanceHistoryHandler),
    // new RouteListItem('/ryzthn/rpc/GetAccountBalance', {}, handlers.GetAccountBalanceHandler),
    // new RouteListItem('/ryzthn/rpc/GetUserCount', {}, handlers.GetUserCountHandler),
    // new RouteListItem('/ryzthn/rpc/GetUsersInRankedCount', {}, handlers.GetUsersInRankedCountHandler),
];
...
export function request(route: RouteListItem) {
    ...
    .then((res: Response) => route.func(res))
    .catch(e => {
